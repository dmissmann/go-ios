...
const (
	PairStateStartRequest     = PairingState(0x01)
	PairStateStartResponse    = PairingState(0x02)
	PairStateVerifyRequest    = PairingState(0x03)
	PairStateVerifyResponse   = PairingState(0x04)
	PairStateExchangeRequest  = PairingState(0x05)
	PairStateExchangeResponse = PairingState(0x06)
	PairStateDone             = PairingState(0x07)
)
...
func (r TlvReader) ReadCoalesced(t TlvType) []byte {
